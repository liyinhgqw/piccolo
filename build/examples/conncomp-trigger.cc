...
#line 1 "../src/examples/conncomp-trigger.pp"
...
int ShortestPathTrigger(const ConfigData& conf) {
  ...
  if (!m.restore()) {
    ...
    m.run_all("___src_examples_conncomp_trigger_ppRunKernel1", "run", maxcomp_map);


    //Build adjacency lists by appending RecordTables' contents
    m.run_all("P_P_P_srcP_examplesP_conncompP_triggerP_ppMapKernel2", "map", nodes_record);

	m.run_all("___src_examples_conncomp_trigger_ppRunKernel3", "run", maxcomp_map);
  }
  ...
  m.run_all("___src_examples_conncomp_trigger_ppRunKernel4", "run", maxcomp_map);
...
class ___src_examples_conncomp_trigger_ppRunKernel1 : public DSMKernel {
public:
  virtual ~___src_examples_conncomp_trigger_ppRunKernel1 () {}
  void run() {
#line 167 "../src/examples/conncomp-trigger.pp"
...
REGISTER_KERNEL(___src_examples_conncomp_trigger_ppRunKernel1);
REGISTER_METHOD(___src_examples_conncomp_trigger_ppRunKernel1, run);


class P_P_P_srcP_examplesP_conncompP_triggerP_ppMapKernel2 : public DSMKernel {
public:
  virtual ~P_P_P_srcP_examplesP_conncompP_triggerP_ppMapKernel2() {}
  template <class K, class Value0>
  void run_iter(const K& k, Value0 &n) {
#line 178 "../src/examples/conncomp-trigger.pp"
...
REGISTER_KERNEL(P_P_P_srcP_examplesP_conncompP_triggerP_ppMapKernel2);
REGISTER_METHOD(P_P_P_srcP_examplesP_conncompP_triggerP_ppMapKernel2, map);


class ___src_examples_conncomp_trigger_ppRunKernel3 : public DSMKernel {
public:
  virtual ~___src_examples_conncomp_trigger_ppRunKernel3 () {}
  void run() {
#line 186 "../src/examples/conncomp-trigger.pp"
...
REGISTER_KERNEL(___src_examples_conncomp_trigger_ppRunKernel3);
REGISTER_METHOD(___src_examples_conncomp_trigger_ppRunKernel3, run);


class ___src_examples_conncomp_trigger_ppRunKernel4 : public DSMKernel {
public:
  virtual ~___src_examples_conncomp_trigger_ppRunKernel4 () {}
  void run() {
#line 207 "../src/examples/conncomp-trigger.pp"
...
REGISTER_KERNEL(___src_examples_conncomp_trigger_ppRunKernel4);
REGISTER_METHOD(___src_examples_conncomp_trigger_ppRunKernel4, run);
