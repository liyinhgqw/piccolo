...
#line 1 "../src/examples/conncomp.pp"
...
int ShortestPath(const ConfigData& conf) {
  ...
  if (!m.restore()) {
  m.run_all("___src_examples_conncomp_ppRunKernel1", "run", maxcomp_map);
...
class ___src_examples_conncomp_ppRunKernel1 : public DSMKernel {
public:
  virtual ~___src_examples_conncomp_ppRunKernel1 () {}
  void run() {
#line 85 "../src/examples/conncomp.pp"
...
REGISTER_KERNEL(___src_examples_conncomp_ppRunKernel1);
REGISTER_METHOD(___src_examples_conncomp_ppRunKernel1, run);
