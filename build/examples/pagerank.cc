...
#line 1 "../src/examples/pagerank.pp"
...
int Pagerank(const ConfigData& conf) {
  ...
  m.run_all("___src_examples_pagerank_ppRunKernel1", "run", curr_pr);
  ...
  while (!done) {
    m.run_all("___src_examples_pagerank_ppRunKernel2", "run", pages);

    // Find per-shard max delta
    m.run_all("___src_examples_pagerank_ppRunKernel3", "run", curr_pr);

    // Find overall max delta, establish quiescence state
    m.run_one("___src_examples_pagerank_ppRunKernel4", "run", maxtol);
  ...
  //Final evaluation
  m.run_one("___src_examples_pagerank_ppRunKernel5", "run", curr_pr);
...
class ___src_examples_pagerank_ppRunKernel1 : public DSMKernel {
public:
  virtual ~___src_examples_pagerank_ppRunKernel1 () {}
  void run() {
#line 381 "../src/examples/pagerank.pp"
...
REGISTER_KERNEL(___src_examples_pagerank_ppRunKernel1);
REGISTER_METHOD(___src_examples_pagerank_ppRunKernel1, run);


class ___src_examples_pagerank_ppRunKernel2 : public DSMKernel {
public:
  virtual ~___src_examples_pagerank_ppRunKernel2 () {}
  void run() {
#line 407 "../src/examples/pagerank.pp"
...
REGISTER_KERNEL(___src_examples_pagerank_ppRunKernel2);
REGISTER_METHOD(___src_examples_pagerank_ppRunKernel2, run);


class ___src_examples_pagerank_ppRunKernel3 : public DSMKernel {
public:
  virtual ~___src_examples_pagerank_ppRunKernel3 () {}
  void run() {
#line 433 "../src/examples/pagerank.pp"
...
REGISTER_KERNEL(___src_examples_pagerank_ppRunKernel3);
REGISTER_METHOD(___src_examples_pagerank_ppRunKernel3, run);


class ___src_examples_pagerank_ppRunKernel4 : public DSMKernel {
public:
  virtual ~___src_examples_pagerank_ppRunKernel4 () {}
  void run() {
#line 448 "../src/examples/pagerank.pp"
...
REGISTER_KERNEL(___src_examples_pagerank_ppRunKernel4);
REGISTER_METHOD(___src_examples_pagerank_ppRunKernel4, run);


class ___src_examples_pagerank_ppRunKernel5 : public DSMKernel {
public:
  virtual ~___src_examples_pagerank_ppRunKernel5 () {}
  void run() {
#line 493 "../src/examples/pagerank.pp"
        ...
        for(int i=0; i<FLAGS_show_top; i++) {
          ...
          for(; !it->done(); it->Next()) {
            ...
            pr_min = it->value();
            pr_sum += it->value();
          }}if (0 >= totalpages) {LOG(FATAL) << "No pages found in output table!" << endl;}float pr_avg = pr_sum/totalpages;
...
REGISTER_KERNEL(___src_examples_pagerank_ppRunKernel5);
REGISTER_METHOD(___src_examples_pagerank_ppRunKernel5, run);
