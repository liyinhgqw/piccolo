...
#line 1 "../src/examples/accelpagerank.pp"
...
int AccelPagerank(const ConfigData& conf) {
  ...
  if (!FLAGS_apr_convert_graph.empty()) {
    ...
    m.run_all("___src_examples_accelpagerank_ppRunKernel1", "run", prs);
    return 0;
  }

  m.run_all("___src_examples_accelpagerank_ppRunKernel2", "run", prs);
  ...
  fprintf(stderr, "%successfully restore%s previous checkpoint.\n",
	...
	m.run_all("___src_examples_accelpagerank_ppRunKernel3", "run", pagedb);
  ...
  m.run_all("___src_examples_accelpagerank_ppRunKernel4", "run", pagedb);

  m.run_all("___src_examples_accelpagerank_ppRunKernel5", "run", prs);

  //Start it all up by poking the thresholding process with a "null" update on the newly-initialized nodes.
  m.run_all("___src_examples_accelpagerank_ppRunKernel6", "run", prs);
  ...
  m.run_one("___src_examples_accelpagerank_ppRunKernel7", "run", prs);
...
class ___src_examples_accelpagerank_ppRunKernel1 : public DSMKernel {
public:
  virtual ~___src_examples_accelpagerank_ppRunKernel1 () {}
  void run() {
#line 365 "../src/examples/accelpagerank.pp"
...
REGISTER_KERNEL(___src_examples_accelpagerank_ppRunKernel1);
REGISTER_METHOD(___src_examples_accelpagerank_ppRunKernel1, run);


class ___src_examples_accelpagerank_ppRunKernel2 : public DSMKernel {
public:
  virtual ~___src_examples_accelpagerank_ppRunKernel2 () {}
  void run() {
#line 371 "../src/examples/accelpagerank.pp"
...
REGISTER_KERNEL(___src_examples_accelpagerank_ppRunKernel2);
REGISTER_METHOD(___src_examples_accelpagerank_ppRunKernel2, run);


class ___src_examples_accelpagerank_ppRunKernel3 : public DSMKernel {
public:
  virtual ~___src_examples_accelpagerank_ppRunKernel3 () {}
  void run() {
#line 379 "../src/examples/accelpagerank.pp"
...
REGISTER_KERNEL(___src_examples_accelpagerank_ppRunKernel3);
REGISTER_METHOD(___src_examples_accelpagerank_ppRunKernel3, run);


class ___src_examples_accelpagerank_ppRunKernel4 : public DSMKernel {
public:
  virtual ~___src_examples_accelpagerank_ppRunKernel4 () {}
  void run() {
#line 402 "../src/examples/accelpagerank.pp"
...
REGISTER_KERNEL(___src_examples_accelpagerank_ppRunKernel4);
REGISTER_METHOD(___src_examples_accelpagerank_ppRunKernel4, run);


class ___src_examples_accelpagerank_ppRunKernel5 : public DSMKernel {
public:
  virtual ~___src_examples_accelpagerank_ppRunKernel5 () {}
  void run() {
#line 423 "../src/examples/accelpagerank.pp"
...
REGISTER_KERNEL(___src_examples_accelpagerank_ppRunKernel5);
REGISTER_METHOD(___src_examples_accelpagerank_ppRunKernel5, run);


class ___src_examples_accelpagerank_ppRunKernel6 : public DSMKernel {
public:
  virtual ~___src_examples_accelpagerank_ppRunKernel6 () {}
  void run() {
#line 428 "../src/examples/accelpagerank.pp"
...
REGISTER_KERNEL(___src_examples_accelpagerank_ppRunKernel6);
REGISTER_METHOD(___src_examples_accelpagerank_ppRunKernel6, run);


class ___src_examples_accelpagerank_ppRunKernel7 : public DSMKernel {
public:
  virtual ~___src_examples_accelpagerank_ppRunKernel7 () {}
  void run() {
#line 456 "../src/examples/accelpagerank.pp"
...
REGISTER_KERNEL(___src_examples_accelpagerank_ppRunKernel7);
REGISTER_METHOD(___src_examples_accelpagerank_ppRunKernel7, run);
