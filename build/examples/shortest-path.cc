...
#line 1 "../src/examples/shortest-path.pp"
...
int ShortestPath(const ConfigData& conf) {
  ...
  if (!m.restore()) {
  m.run_all("___src_examples_shortest_path_ppRunKernel1", "run", distance_map);
...
class ___src_examples_shortest_path_ppRunKernel1 : public DSMKernel {
public:
  virtual ~___src_examples_shortest_path_ppRunKernel1 () {}
  void run() {
#line 88 "../src/examples/shortest-path.pp"
...
REGISTER_KERNEL(___src_examples_shortest_path_ppRunKernel1);
REGISTER_METHOD(___src_examples_shortest_path_ppRunKernel1, run);
