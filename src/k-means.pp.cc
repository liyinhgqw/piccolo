...
class examples_k_means_ppRunKernel1 : public DSMKernel {
public:
  virtual ~examples_k_means_ppRunKernel1 () {}
  void run() {
#line 48 "examples/k-means.pp"
...
REGISTER_KERNEL(examples_k_means_ppRunKernel1);
REGISTER_METHOD(examples_k_means_ppRunKernel1, run);


class examples_k_means_ppRunKernel2 : public DSMKernel {
public:
  virtual ~examples_k_means_ppRunKernel2 () {}
  void run() {
#line 57 "examples/k-means.pp"
...
REGISTER_KERNEL(examples_k_means_ppRunKernel2);
REGISTER_METHOD(examples_k_means_ppRunKernel2, run);


class examplesP_kP_meansP_ppMapKernel3 : public DSMKernel {
public:
  virtual ~examplesP_kP_meansP_ppMapKernel3() {}
  template <class K, class Value0>
  void run_iter(const K& k, Value0 &p) {
#line 70 "examples/k-means.pp"
...
REGISTER_KERNEL(examplesP_kP_meansP_ppMapKernel3);
REGISTER_METHOD(examplesP_kP_meansP_ppMapKernel3, map);


class examplesP_kP_meansP_ppMapKernel4 : public DSMKernel {
public:
  virtual ~examplesP_kP_meansP_ppMapKernel4() {}
  template <class K, class Value0>
  void run_iter(const K& k, Value0 &c) {
#line 84 "examples/k-means.pp"
...
REGISTER_KERNEL(examplesP_kP_meansP_ppMapKernel4);
REGISTER_METHOD(examplesP_kP_meansP_ppMapKernel4, map);


class examplesP_kP_meansP_ppMapKernel5 : public DSMKernel {
public:
  virtual ~examplesP_kP_meansP_ppMapKernel5() {}
  template <class K, class Value0>
  void run_iter(const K& k, Value0 &p) {
#line 94 "examples/k-means.pp"
...
REGISTER_KERNEL(examplesP_kP_meansP_ppMapKernel5);
REGISTER_METHOD(examplesP_kP_meansP_ppMapKernel5, map);
